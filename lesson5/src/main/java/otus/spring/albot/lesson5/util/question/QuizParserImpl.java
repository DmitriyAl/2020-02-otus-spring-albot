...
import otus.spring.albot.lesson5.Lesson5Application;
...
public class QuizParserImpl implements QuizParser {
    ...
    private List<CSVRecord> getRecords() {
        ...
        try {
            CSVParser parser = CSVFormat.DEFAULT.parse(new InputStreamReader(Lesson5Application.class.getResourceAsStream(fileName)));
